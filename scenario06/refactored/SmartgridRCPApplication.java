...
import smartgrid.newsimcontrol.rcp.commands.DomainControllerCommand;
...
public class SmartgridRCPApplication implements IApplication {
    ...
    public Object start(IApplicationContext context) throws Exception {
        ...
        if (arguments.length == 0) {
            ...
            DomainControllerCommand cCommand = getCommand(arguments[0]);
    ...
    private DomainControllerCommand getCommand(String commandString) {
        SimControlCommands command = null;
        DomainControllerCommand cCommand = null;
        try {
        ...
        var controller = new DomainLocalController();// (LocalController) Activator.getInstance().getController();
    ...
    private void applyArguments(DomainControllerCommand cCommand, String[] arguments) throws SimcontrolException, InterruptedException {
