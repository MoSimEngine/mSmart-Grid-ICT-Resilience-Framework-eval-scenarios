...
public class InitTopoCommand extends DomainControllerCommand {
    public InitTopoCommand(DomainLocalController controller) {
        super(controller);
    }
    ...
    public void doCommand(String[] args) throws SimcontrolException {
        ...
        DomainEObjectsHelper.saveToFileSystem(controller.getTopo(), args[3]);
        DomainEObjectsHelper.saveToFileSystem(controller.getInitalState(), args[4]);
        DomainEObjectsHelper.saveToFileSystem(controller.getInitalState(), args[4] + "original");
    }
}