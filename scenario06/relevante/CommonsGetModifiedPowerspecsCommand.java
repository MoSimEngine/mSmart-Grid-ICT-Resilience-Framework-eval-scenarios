...
public class CommonsGetModifiedPowerspecsCommand extends AnalysisControllerCommand {
    public CommonsGetModifiedPowerspecsCommand(AnalysisLocalController controller) {
        super(controller);
    }
    ...
    protected void doCommand(String[] args) throws SimcontrolException, InterruptedException {
        ...
        SmartGridTopology topo = AnalysisEObjectsHelper.loadTopology(args[1]);
        ScenarioState state = AnalysisEObjectsHelper.loadInput(args[2]);
        ...
        try {
            ...
            AnalysisEObjectsHelper.saveToFileSystem(topo, args[1]);
            AnalysisEObjectsHelper.saveToFileSystem(state, args[2]);
