...
import smartgrid.attackersimulation.strategies.CommonsBFSStrategy;
import smartgrid.attackersimulation.strategies.CommonsDFSStrategy;
import smartgrid.attackersimulation.strategies.CommonsFullyMeshedStrategy;
...
public class CommonsLocalHacker implements IAttackerSimulation {
    ...
    protected void initForTest(String hackingStyle, String hackingSpeed, String rootNode) {
        ...
        switch (hackingType) {
            case BFS_HACKING :
                this.hackingTypes = new CommonsBFSStrategy(this.ignoreLogicalConnections, this.hackingSpeed);
                break;
            case DFS_HACKING :
                this.hackingTypes = new CommonsDFSStrategy(this.ignoreLogicalConnections, this.hackingSpeed);
                break;
            case FULLY_MESHED_HACKING :
                this.hackingTypes = new CommonsFullyMeshedStrategy(this.hackingSpeed);
                break;
            default :
                assert false;
                break;
