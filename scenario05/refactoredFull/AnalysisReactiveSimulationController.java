...
import smartgrid.model.topo.generator.AnalysisDefaultInputGenerator;
import smartgrid.model.topo.generator.ITopoGenerator;
import smartgrid.model.topo.generator.ring.DomainRingTopoGenerator;
import smartgrid.model.topo.generator.star.DomainStarTopoGenerator;
import smartgrid.model.topo.generator.starstar.DomainStarStarTopoGenerator;
import smartgrid.model.topo.generator.trivial.DomainTrivialTopoGenerator;
import smartgrid.newsimcontrol.AnalysisReportGenerator;
...
public class AnalysisReactiveSimulationController extends DomainReactiveSimulationController {
    ...
    protected void initModelsFromFiles(String topoPath, String inputStatePath) {
        // load models
        this.initialState = AnalysisScenarioModelHelper.loadInput(inputStatePath);
        this.impactInput = this.initialState;
        this.topo = AnalysisScenarioModelHelper.loadScenario(topoPath);
    ...
    protected List<ICTElement> initTopo(SmartGridTopoContainer topoContainer) {
        ...
        if (this.topoGenerationStyle == null) {
            generator = new DomainTrivialTopoGenerator();
        } else {
            switch (this.topoGenerationStyle) {
                case STERN_TOPO :
                    generator = new DomainStarTopoGenerator();
                    break;
                case RING_TOPO :
                    generator = new DomainRingTopoGenerator();
                    break;
                case STERN_STERN_TOPO :
                    generator = new DomainStarStarTopoGenerator();
                    break;
                default :
                    generator = new DomainTrivialTopoGenerator();
                    break;
        ...
        AnalysisDefaultInputGenerator defaultInputGenerator = new AnalysisDefaultInputGenerator();
    ...
    protected SmartComponentStateContainer run(PowerAssigned power) {
        ...
        AnalysisReportGenerator.saveScenarioResult(resultReportPath, currentimpactResult);
