...
public class CommonsLocalHacker implements IAttackerSimulation {
    ...
    protected void rootNodeUpdate() {
        if (this.rootNodeID.equalsIgnoreCase(Constants.NO_ROOT_NODE_ID)) {
            ...
            this.rootNodeID = DomainScenarioModelHelper.selectRandomRoot(this.ignoreLogicalConnections, this.scenarioResult);
        }
        this.rootNodeState = DomainScenarioModelHelper.findEntityOnStateFromID(this.rootNodeID, this.scenarioResult);// update
