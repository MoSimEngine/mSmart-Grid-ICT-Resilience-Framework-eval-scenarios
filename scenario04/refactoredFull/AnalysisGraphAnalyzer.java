...
import smartgrid.model.helper.input.AnalysisLoadInputModelConformityHelper;
import smartgrid.simcontrol.test.baselib.Constants;
import topo.ControlCenter;
import topo.SmartGridTopology;
import topo.SmartMeter;
public class AnalysisGraphAnalyzer extends CommonsGraphAnalyzer {
    /**
     * For ExtensionPoints .. use this together with the init() Method
     */
    public AnalysisGraphAnalyzer() {
    }
     ...
     */
    @Deprecated
    public AnalysisGraphAnalyzer(final String outputPath) {
    ...
    protected ScenarioResult run(final SmartGridTopology smartGridTopo, final ScenarioState impactAnalysisInput) {
        ...
        this.clearAll();
        if (!AnalysisLoadInputModelConformityHelper.checkInputModelConformity(impactAnalysisInput, smartGridTopo)) {
